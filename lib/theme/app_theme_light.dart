...
ThemeData lightThemeData = ThemeData(
  ...
  listTileTheme: ListTileThemeData(
    ...
    selectedColor: AppColorsLight.instance.primaryColorYellow,
  ...
  elevatedButtonTheme: ElevatedButtonThemeData(
    style: ElevatedButton.styleFrom(
      ...
      backgroundColor: AppColorsLight.instance.primaryColorYellow,
  ...
  primaryColor: AppColorsLight.instance.primaryColorYellow,
  highlightColor: AppColorsLight.instance.primaryColorBrownDark2,
  primarySwatch:
      generateMaterialColor(AppColorsLight.instance.primaryColorYellow),
  ...
  textTheme: TextTheme(
    ...
    headlineSmall: AppTextStyle.text14Reg.copyWith(
      color: AppColorsLight.instance.primaryColorYellow,
    ),
